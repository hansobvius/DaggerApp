...
import com.android.daggerapp.BR;
...
public class ActivityMainBindingImpl extends ActivityMainBinding  {
    ...
    public boolean setVariable(int variableId, @Nullable Object variable)  {
        ...
        if (BR.viewModel == variableId) {
            setViewModel((com.android.daggerapp.viewModel.MainViewModel) variable);
        }
        else {
            variableSet = false;
        }
    ...
    public void setViewModel(@Nullable com.android.daggerapp.viewModel.MainViewModel ViewModel) {
